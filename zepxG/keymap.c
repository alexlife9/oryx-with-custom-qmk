...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    RU_YO,          LCTL(KC_Z),     KC_LEFT_CTRL,   KC_LEFT_SHIFT,  ST_MACRO_4,     KC_ENTER,                                                                                                       KC_BSPC,        RU_DOT,         LCTL(KC_A),     LCTL(KC_F),     ST_MACRO_9,     TO(1),          
  ...
  [3] = LAYOUT_moonlander(
    ...
    ST_MACRO_17,    KC_NO,          KC_NO,          KC_NO,          KC_NO,          ST_MACRO_18,                                    KC_NO,          RU_HARD,        LCTL(KC_B),     LCTL(LSFT(KC_X)),KC_NO,          KC_NO,          
