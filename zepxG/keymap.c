...
const uint16_t PROGMEM combo7[] = { KC_RPRN, KC_RBRC, COMBO_END};
const uint16_t PROGMEM combo8[] = { KC_KP_SLASH, TO(1), COMBO_END};
const uint16_t PROGMEM combo9[] = { MT(MOD_LCTL, KC_DELETE), KC_SPACE, COMBO_END};
